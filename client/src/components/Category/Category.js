                ...
                <div className="category__card__container">
                    <div className="category__product__card">
                        ...
                        <div className="show__more__action">
                            <Button variant='outlined' sx={[ {width: '200px', height: '50px', borderRadius: '20px' , fontWeight: '700', backgroundColor: 'var(--color-accent)', borderColor: 'var(--color-accent)', color: '#fff' }, {'&:hover': { borderColor: 'var(--color-accent)', backgroundColor: 'transparent', color: 'var(--color-accent)' }}]}>Show more</Button>
                        </div>
                    </div>
                </div>
            </div>
