                ...
                <div className="collect__item__actions">
                    <div className="add__cart__add__wish">
                        <div className="add__cart">
                            <Button variant="outlined" size="large" sx={[{'&:hover': { backgroundColor: 'var(--color-accent)', borderColor: 'var(--color-accent)', borderWidth: '3px', color: '#fff'}, minWidth: 200, borderColor: 'var(--color-accent)', backgroundColor: "var(--color-accent)" , color: "#fff", borderWidth: '3px'}]} onClick={handelAddToCart}>ADD TO BAG</Button>
                        </div>
                        <div className="add__wish">
                            <IconButton variant="outlined" size="large" sx={[{'&:hover': { backgroundColor: 'var(--color-accent)', borderColor: 'var(--color-accent)', borderWidth: '3px', color: '#fff'}, borderColor: 'var(--color-accent)', backgroundColor: "var(--color-accent)" , color: "#fff", borderWidth: '3px'}]} onClick={handelAddToWish}>
